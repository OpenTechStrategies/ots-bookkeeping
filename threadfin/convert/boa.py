...
regex = {"summary": re.compile(r"^([,\w ]+)\b +\$?(-?[\d.,]+)")}
    ...
    def parse(self):
        ...
        for i in range(len(lines)):
            ...
            if line == "Deposits and other credits" or mode == "DEPOSITS AND ADDITIONS":
                ...
                if (
                    line[2] == "/"
                ):  # Slash indicates a date, which indicates a transaction
            ...
            if (
                line == "Withdrawals and other debits"
                or mode == "Withdrawals and other debits"
            ):
            ...
            if line == "Service fees" or mode == "Service fees":
                ...
                if line[2] == "/" and line[8] != ":":
                    ...
                    self.transactions.append(t)
            if (
                line.startswith("Daily ledger balance")
